...
public final class IntentUtils {
     ...
     */
    public static Intent getInstallAppIntent(final Context context, final String filePath, final String authority) {
        return getInstallAppIntent(context.getApplicationContext(), FileUtils.getFileByPath(filePath), authority);
    }
     ...
     * @return 安装 App(支持 8.0)的意图
     */
    public static Intent getInstallAppIntent(final Context context, final File file, final String authority) {
        return getInstallAppIntent(context.getApplicationContext(), file, authority, false);
    }
    ...
    public static Intent getLaunchAppIntent(final Context context, final String packageName) {
        return getLaunchAppIntent(context.getApplicationContext(), packageName, false);
    }
